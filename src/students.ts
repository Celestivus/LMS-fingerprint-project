...
export const SECTION_EVENTS: Record<string, ClassEvent[]> = {
  ...
  'LOG-23-01': [
    { id: 1, name: 'Logistics Mgmt', day: 'Tuesday', start: '09:30', end: '11:00', type: 'lecture' },
    { id: 2, name: 'Supply Chain Lab', day: 'Thursday', start: '10:00', end: '11:30', type: 'lab' },
    { id: 3, name: 'Business Stats', day: 'Monday', start: '11:30', end: '13:00', type: 'lecture' },
    { id: 4, name: 'Global Logistics', day: 'Wednesday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 5, name: 'Principles of Accounting', day: 'Friday', start: '09:30', end: '11:00', type: 'lecture' },
    { id: 6, name: 'Business Comm.', day: 'Saturday', start: '10:00', end: '11:30', type: 'lecture' },
  ],
  'LOG-23-02': [
    { id: 1, name: 'Logistics Mgmt', day: 'Monday', start: '09:30', end: '11:00', type: 'lecture' },
    { id: 2, name: 'Business Stats', day: 'Tuesday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 3, name: 'Supply Chain Lab', day: 'Wednesday', start: '10:00', end: '11:30', type: 'lab' },
    { id: 4, name: 'Global Logistics', day: 'Thursday', start: '11:30', end: '13:00', type: 'lecture' },
    { id: 5, name: 'Principles of Accounting', day: 'Friday', start: '14:00', end: '15:30', type: 'lecture' },
  ],
  'BUS-23-01': [
    { id: 1, name: 'Business Ethics', day: 'Monday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 2, name: 'Macroeconomics', day: 'Friday', start: '10:00', end: '11:30', type: 'lecture' },
    { id: 3, name: 'Principles of Management', day: 'Tuesday', start: '11:30', end: '13:00', type: 'lecture' },
    { id: 4, name: 'Marketing Management', day: 'Wednesday', start: '09:30', end: '11:00', type: 'lecture' },
    { id: 5, name: 'Financial Accounting', day: 'Thursday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 6, name: 'Microeconomics', day: 'Saturday', start: '11:30', end: '13:00', type: 'lecture' },
  ],
  'BUS-23-02': [
    { id: 1, name: 'Business Ethics', day: 'Tuesday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 2, name: 'Principles of Management', day: 'Monday', start: '11:30', end: '13:00', type: 'lecture' },
    { id: 3, name: 'Marketing Management', day: 'Wednesday', start: '11:30', end: '13:00', type: 'lecture' },
    { id: 4, name: 'Financial Accounting', day: 'Thursday', start: '09:30', end: '11:00', type: 'lecture' },
    { id: 5, name: 'Macroeconomics', day: 'Friday', start: '14:00', end: '15:30', type: 'lecture' },
    { id: 6, name: 'Microeconomics', day: 'Monday', start: '15:30', end: '17:00', type: 'lecture' },
  ]
};
